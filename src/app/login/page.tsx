...
export default function Login() {
  ...
  const signInWithEmailAndPasswordHandler: SubmitHandler<IFormInput> = async (
    data
  ) => {
    setLoading(true);
    try {
      ...
      {loading ? (
        ...
        <main className="font-[sans-serif] text-[#333]">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 items-center lg:gap-8 gap-4 h-full">
            {/**Left column for Image Part */}
            <div className="max-md:order-1 lg:col-span-2 md:h-screen w-full bg-[#141414] md:rounded-tr-xl md:rounded-br-xl lg:p-12 p-8">
              <Image
                ...
                <div className="mt-8">
                  ...
                  <div className="relative flex items-center">
                    ...
                    {errors.password && (
                      <p
                        role="alert"
                        className="text-xs absolute bottom-1 text-red-900 text-center"
                      >
